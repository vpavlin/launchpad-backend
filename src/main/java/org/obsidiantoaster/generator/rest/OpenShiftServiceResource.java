...
import org.obsidiantoaster.generator.util.Strings;
...
public class OpenShiftServiceResource
{
   ...
   public Response proxyRequest(String namespace, String path,
            HttpHeaders headers, UriInfo uriInfo, String serviceName, String method, String body)
   {
      String authorization = headers.getHeaderString("Authorization");
      System.out.println("Got auth header: " + authorization);
      ...
      if (Strings.isEmpty(openShiftApiUrl))
      {
